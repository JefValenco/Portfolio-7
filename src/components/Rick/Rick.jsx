  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={styles.cardText} style={{ textAlign: "center" }}>
            "Rick & Morthy" is a full stack React app with PostgreSQL database
            and REST API for comprehensive CRUD functionality.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className={styles.cardText} style={{ textAlign: "center" }}>
          <div style={{ textAlign: "center" }}>
            {" "}
            <a href="https://github.com/JefValenco/PI_RICK" target="_blank">
            ...
            <a
              ...
              href="https://pi-rick-gaax.vercel.app/"
              target="_blank"
            >
      ...
      <div style={{ paddingTop: "2em" }}>
        {" "}
        <img
          src={screencaptureRick}
          alt="screencaptureRick"
