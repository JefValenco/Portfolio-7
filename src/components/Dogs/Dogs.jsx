    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={styles.cardText} style={{ textAlign: "center" }}>
            "Dogs" is a full stack React app with PostgreSQL database and REST
      ...
      <div className={styles.videoContainer}>
        ...
        <video className={styles.video} width="100%" height="auto" controls>
          <source src={dogsVideo} type="video/mp4" />
        </video>
      </div>
      ...
      >
        ...
        <p className={styles.cardText} style={{ textAlign: "center" }}>
          <div style={{ textAlign: "center" }}>
            {" "}
            <a href="https://github.com/JefValenco/Dogs" target="_blank">
            ...
            <a
              href="https://dogs-three-green.vercel.app/"
              target="_blank"
      ...
      <div style={{ paddingTop: "2em" }}>
        {" "}
        <img
          src={screencaptureDogs}
          alt="screencaptureDogs"
