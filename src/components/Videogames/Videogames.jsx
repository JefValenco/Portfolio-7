    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={styles.cardText} style={{ textAlign: "center" }}>
            "Videogame" is a full stack React app with PostgreSQL database and
      ...
      <div className={styles.videoContainer}>
        ...
        <video className={styles.video} width="100%" height="auto" controls>
          <source src={videogameVideo} type="video/mp4" />
        </video>
      </div>
      ...
      >
        ...
        <p className={styles.cardText} style={{ textAlign: "center" }}>
          <div style={{ textAlign: "center" }}>
            {" "}
            <a
              href="https://github.com/JefValenco/PI-Videogames-main"
              target="_blank"
            >
            ...
            <a
              href="https://pi-videogames-main-nu.vercel.app/"
              target="_blank"
      ...
      <div style={{ paddingTop: "2em" }}>
        {" "}
        <img
          src={screencaptureVideogame}
          alt="screencaptureVideogame"
