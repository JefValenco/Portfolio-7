...
import styles from "./Pintario.module.css";

import { bahiaVideo, expe7, figma9 } from "../../images/images.js";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={styles.cardText} style={{ textAlign: "center" }}>
            "Bahia Website" is a full stack React app with PostgreSQL database
            and REST API for comprehensive CRUD functionality. Desing for a
            Webcam Studio.
          </p>
        </div>
      </div>
      ...
      <div style={{ paddingTop: "2em" }}>
        {" "}
        <img src={figma9} alt="figma9" className={styles.imageFrame} />
      </div>

      <div className={styles.videoContainer}>
        {" "}
        <video className={styles.video} width="100%" height="auto" controls>
          <source src={bahiaVideo} type="video/mp4" />
        </video>
      </div>
