    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={styles.cardText} style={{ textAlign: "center" }}>
            "Spoonacular" is a full stack React app with PostgreSQL database and
      ...
      <div className={styles.videoContainer}>
        ...
        <video className={styles.video} width="100%" height="auto" controls>
          <source src={spoonacularVideo} type="video/mp4" />
        </video>
      </div>
      ...
      >
        ...
        <p className={styles.cardText} style={{ textAlign: "center" }}>
          <div style={{ textAlign: "center" }}>
            {" "}
            <a href="https://github.com/JefValenco/Food" target="_blank">
            ...
            <a
              href="https://food-gamma-eight.vercel.app/"
              target="_blank"
      ...
      <div style={{ paddingTop: "2em" }}>
        {" "}
        <img
          src={screencaptureFood}
          alt="screencaptureFood"
